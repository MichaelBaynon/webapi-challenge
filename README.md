...
it has a large amount of frameworks based soley on it it also has middleware included


- [ ] Describe Middleware?
middleware is there to catch errors and be a middleman for code being ran and then sent

- [ ] Describe a Resource?
a resource in nodes context... the actual info that the db produces stores changes etc


- [ ] What can the API return to help clients know if a request was successful?
a success message opposed to an error message which are also helpful
